...
ENDPOINT = "a3j306p4krxnlw-ats.iot.eu-west-3.amazonaws.com"

# Resolve cert/key/CA paths relative to the repo root so the script can be run
# from any working directory (e.g., `src/`).
REPO_ROOT = Path(__file__).resolve().parent.parent
PATH_TO_CERTIFICATE = str(REPO_ROOT / "files" / "test.cert.pem")
PATH_TO_PRIVATE_KEY = str(REPO_ROOT / "files" / "test.private.key")
PATH_TO_AMAZON_ROOT_CA_1 = str(REPO_ROOT / "files" / "root-CA.crt")
